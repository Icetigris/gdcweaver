...
namespace WorldWeaver
{
    class StoryScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            ScreenManager.SpriteBatch.DrawString(_titleFont, "Story", textPosition + new Vector2(-50, Globals.titleDown), Color.Gold);
           ...
           +""
           ,textPosition + new Vector2(0, 150), Color.White);
